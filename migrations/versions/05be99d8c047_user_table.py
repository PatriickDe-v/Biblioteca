...
Revision ID: 05be99d8c047
Revises: 
Create Date: 2023-03-06 20:24:10.633181
...
def upgrade():
    ...
    with op.batch_alter_table('user', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_user_address'), ['address'], unique=True)
